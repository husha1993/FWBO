'''
https://github.com/cbschaff/nlimb/blob/master/xml_parser.py
'''
import numpy as np
...
if __name__ == '__main__':
    import os, inspect
    currentdir = os.path.join(os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe()))))

    robot = MuJoCoXmlRobot(os.path.join(currentdir, 'ant.xml'))
    #[torso radius, front_left_thigh_length, front_left_thigh_radius,
    #['torso-radius', 'front_left_leg-length', 'front_left_leg-radius', 'aux_1-length', 'aux_1-radius', 'front_left_foot-length', 'front_left_foot-radius', \
    # 'front_right_leg-length', 'front_right_leg-radius', 'aux_2-length', 'aux_2-radius', 'front_right_foot-length', 'front_right_foot-radius', \
    # 'left_back_leg-length', 'left_back_leg-radius', 'aux_3-length', 'aux_3-radius', 'left_back_foot-length', 'left_back_foot-radius', \
    # 'right_back_leg-length', 'right_back_leg-radius', 'aux_4-length', 'aux_4-radius', 'right_back_foot-length', 'right_back_foot-radius']
    #default:
    # [0.25, 0.28284271247461906, 0.08, 0.28284271247461906, 0.08, 0.5656854249492381, 0.08, \
    # 0.28284271247461906, 0.08, 0.28284271247461906, 0.08, 0.5656854249492381, 0.08, \
    # 0.28284271247461906, 0.08, 0.28284271247461906, 0.08, 0.5656854249492381, 0.08, \
    # 0.28284271247461906, 0.08, 0.28284271247461906, 0.08, 0.5656854249492381, 0.08]
    #limits:
    #[[0.05, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035, 0.175, 0.035], \
    # [0.4, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085, 0.8, 0.085]]

    params = [.1, .2,.06,.2,.06,.4,.06, .2,.06,.2,.06,.4,.06, .2,.06,.2,.06,.4,.06, .2,.06,.2,.06,.4,.06]
    #robot.update(params, os.path.join(currentdir, 'test_ant.xml'))
